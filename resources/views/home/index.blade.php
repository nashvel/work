...
<head>
    ...
    <title>Hill Business Consulting Services</title>
    <link rel="icon" type="image/png"  href="/assets/logo.png">
    <link rel="manifest" href="/assets/home/img/favicons/manifest.json?{{ time() }}">
	...
	============================== -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/assets/home/css/bootstrap.min.css?{{ time() }}">
    <!-- Fontawesome Icon -->
    <link rel="stylesheet" href="/assets/home/css/fontawesome.min.css?{{ time() }}">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="/assets/home/css/magnific-popup.min.css?{{ time() }}">
    <!-- Swiper Slider -->
    <link rel="stylesheet" href="/assets/home/css/swiper-bundle.min.css?{{ time() }}">
    <!-- Theme Custom CSS -->
