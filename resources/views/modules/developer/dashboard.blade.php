            ...
            <div class="box">
                <div class="box-body">
                    <h6 class="font-bold text-2xl text-gray-700 dark:text-white">
                        <strong>Developer – Helper</strong>
                    </h6>
                    <hr class="!mt-3">
                    @if ($errors->any())
                        <div
                    ...
                    <div class="sm:border-b-2 border-gray-200 dark:border-white/10">
                        <nav class="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse" role="tablist">
                            @php
                                $tabs = [
                                    ['id' => 'icon-privilege', 'icon' => 'bi-pencil-square', 'label' => 'Form'],
                                    ['id' => 'icon-1', 'icon' => 'bi-pc-display-horizontal', 'label' => 'Table'],
                    ...
                    <div class="mt-3">
                        @foreach ($tabs as $index => $tab)
                            <div id="{{ $tab['id'] }}" class="{{ $index === 0 ? '' : 'hidden' }}" role="tabpanel"
                                ...
                                <div class="p-5 border rounded-sm dark:border-white/10 border-gray-200">
                                    @includeIf(
                                        'modules.developer.generator.' .
