    ...
    $table = [
        ...
        'filters' => [
            ...
            [
                ...
                'name' => 'isActived',
                'label' => 'Status',
                'options' => ['' => 'All', '1' => 'Activated', '0' => 'Deactivated'],
            ],
            [
                'type' => 'select',
                'name' => 'is_verified',
        ...
        'columns' => [
            ...
            [
                ...
                'map' => [
                    '0' =>
                        "<span class='text-bold'><i class=\"ri-close-circle-fill text-danger mx-2 text-[0.5625rem]\"></i>Deactivated</span>",
                    '1' =>
                        "<span class='text-bold'><i class=\"ri-circle-fill text-success mx-2 text-[0.5625rem]\"></i>Activated</span>",
                ],
            ],
            [
                'type' => 'badge_map',
