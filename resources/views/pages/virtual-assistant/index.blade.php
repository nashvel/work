<x-app-layout>
    ...
    <x-slot name="buttons">
        @if (Auth::user()->role == 'Administrator')
            <button class="ti-btn ti-btn-primary !border-0 btn-wave me-0" data-hs-overlay="#create-va">
                <i class="bi bi-person-plus-fill me-1"></i> New Virtual Assistant
            </button>
        @endif
    </x-slot>
    ...
    @include('pages.virtual-assistant.list')
    @include('pages.virtual-assistant.modal')
</x-app-layout>
