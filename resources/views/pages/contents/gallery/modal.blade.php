     ...
     <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
         <div class="ti-modal-content">
             ...
             <div class="ti-modal-header">
                 <h6 class="ti-modal-title">Change Image</h6>
             ...
             <form id="logoForm" method="POST" enctype="multipart/form-data"
                 action="{{ route('cms.gallery.logo.update') }}">
                 @csrf
                 ...
                 <div class="ti-modal-footer justify-end">
                     <button type="submit" id="upload-btn" class="bg-green-500 text-white px-6 py-2 rounded-md">Change Image</button>
                 </div>
             </form>
         </div>
     </div>
             ...
             <script>
                 document.addEventListener("DOMContentLoaded", function() {
                     ...
                     uploadForm.addEventListener("submit", function(e) {
                         ...
                         xhr.open("POST", "{{ route('cms.gallery.store') }}", true);
