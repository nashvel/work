<x-app-layout>
    ...
    <x-slot name="title">CRM Portal Automated Greetings</x-slot>
    <x-slot name="url_1">{"link": "/content/crm/greetings", "text": "CRM Portal Automated Greetings"}</x-slot>
    <x-slot name="active"> {{ isset($id) ? 'Details' : 'CRM Portal Registration' }} </x-slot>
        ...
        <div class="xl:col-span-12 col-span-12">
            <div class="box custom-box">
                <div class="box-header">
                    <div class="box-body">
                        <form action="{{ route('content.crm.greetings.store') }}"  method="POST" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                <div class="xl:col-span-12 col-span-8">
                                    <div class="mb-3">
                                        <label for="client_id" class="form-label">Client Informartion : <strong class="text-danger">*</strong></label>
                                        @if (isset($id))
                                            @php
                            ...
                            <div class="mb-4">
                                <label for="welcome_message" class="form-label">Upload Multimedia : <strong class="text-danger">*</strong></label>
