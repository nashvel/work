<x-app-layout>
    ...
    <x-slot name="title">Manage Client Section</x-slot>
    <x-slot name="url_1">{"link": "/cms/clients", "text": "Manage"}</x-slot>
    <x-slot name="url_2">{"link": "/cms/clients", "text": "Client"}</x-slot>
    ...
    <div class="grid grid-cols-12 gap-x-5">
        <div class="xl:col-span-12 col-span-12">
            ...
            @php
                $galleryItems = App\Models\CMS_Clients::orderBy('img_column')->orderBy('img_row')->get();
            @endphp

            <div class="box">
                <div class="box-body">
                    <i class="bi bi-info-circle px-1"></i> You can manage the client section here.
                    <hr class="mb-3 mt-3">
                                ...
                                <div class="col-span-1 drag-column bg-white" id="post_{{ $col }}">
                                    @foreach ($columnItems as $item)
                                        <div class="box draggable-item relative text-gray-800"
                                            ...
                                            <form action="{{ route('cms.client.info.update', ['id' => $item->id]) }}"
    ...
    @include('pages.contents.clients.modal')
    @include('pages.contents.clients.settings')
