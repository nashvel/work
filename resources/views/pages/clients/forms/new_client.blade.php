...
<form action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data" autocomplete="on">
    ...
    <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
            ...
            <div class="flex items-start flex-wrap gap-4">
                ...
                <div>
                    ...
                    <div class="btn-list mb-1">
                        <label for="profile-change" class="ti-btn ti-btn-sm ti-btn-primary btn-wave">
                            <i class="ri-upload-2-line me-1"></i>Change Image
                        </label>
                        <input type="file" name="photo" id="profile-change" class="hidden" accept="image/*">
                        <button type="button" id="remove-img" class="ti-btn ti-btn-sm ti-btn-soft-primary1 btn-wave">
        ...
        <div class="xl:col-span-12 col-span-12"> <hr></div>
        ...
        <!-- Company -->
        <div class="xl:col-span-6 col-span-12">
            <label for="company" class="form-label">Position</label>
            <div class="relative">
    ...
    <div class="ti-modal-footer mt-3">
        <center>
        <button type="reset" class="hs-dropdown-toggle ti-btn ti-btn-soft-secondary">Reset</button>
