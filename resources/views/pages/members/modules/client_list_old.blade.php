        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const data = clients.map(client => [
                    ...
                    [client.position, client.location], // [2] Company
                    ...
                    columns: [{
                                    ...
                                    <div>
                                        ...
                                        <div class="hs-tooltip ti-main-tooltip">
                                            <span class="block text-textmuted dark:text-textmuted/50 text-[11px]">
                                                <i class="bi bi-calendar-event me-1 text-[13px] align-middle"></i>
                                                ${cell[1]}
                        ...
                        },
                        {
                            ...
                            formatter: (cell) => gridjs.html(`
                                <span class="block mb-1">
                                 ...
                                 <span class="block mb-1">
                                    <i class="bi bi-pin-map me-2 align-middle text-[14px] text-textmuted dark:text-textmuted/50 inline-block"></i>
                                    ${cell[1]}
                                </span>
                            `)
                        },
                        {
                            ...
                            formatter: (cell) => gridjs.html(`
                                <div class="flex mb-1">
                                        ...
                                        <span class="ms-auto text-[12px]"> ${cell[0]} / <strong class="font-semibold">${cell[1]}</strong> </span>
                                    </div>
                        ...
                        },
                        {
                            ...
                            formatter: (cell) => gridjs.html(`
                                <div class="btn-list">
                                    <center>
                                          <a href="/chat/${cell}" class="ti-btn ti-btn-sm ti-btn-soft-success ti-btn-icon !mb-0">
