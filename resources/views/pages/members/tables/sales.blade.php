        ...
        var table = $('#clientTable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                        <span class="bg-light badge" style="color: ${row.status_color}; font-size: 13px">${data}</span>
                        `;
                    }
                },
                {
                        ...
                        return `<div class="hstack gap-1 text-[.9375rem]">
                            <center>
                                <div class="hs-tooltip ti-main-tooltip [--placement:left]">
                                    <a href="/sales/relationship/list/details/${row.id}" 
            ...
            rowCallback: function(row, data) {
                $(row).attr('data-href', `/sales/relationship/list/details/${data.id}`); // Set row link
            },
