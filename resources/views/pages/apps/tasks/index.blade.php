                ...
                <div class="box-body">
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            ...
                            <h4 class="font-medium mb-0 mt-3">{{ App\Models\Task::where('status', 'Pending')->count() }}
                            </h4>
                        </div>
                    ...
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            <span class="text-textmuted dark:text-textmuted/50 block mb-1">In Progress
                                Tasks</span>
                            <h4 class="font-medium mb-0 mt-3">
                                {{ App\Models\Task::where('status', 'In Progress')->count() }}</h4>
                        </div>
                        <div class="leading-none">
                ...
                <div class="box-body">
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            ...
                            <h4 class="font-medium mb-0 mt-3">{{ App\Models\Task::where('status', 'On Hold')->count() }}
                            </h4>
                        </div>
                        <div class="leading-none">
                    ...
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            <span class="text-textmuted dark:text-textmuted/50 block mb-1">Completed
                                Tasks</span>
                            <h4 class="font-medium mb-0 mt-3">
                                {{ App\Models\Task::where('status', 'Completed')->count() }}</h4>
                        </div>
                        <div class="leading-none">
        ...
        <div class="xl:col-span-12 col-span-12">
            <div class="box custom-box">
                <div class="box-header">
                    <div class="box-body">
                        @include('pages.apps.tasks.tables.task')
                    </div>
                </div>
            </div>
        </div>
