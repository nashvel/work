...
<form action="{{ route('task.create') }}" method="POST" enctype="multipart/form-data" autocapitalize="true"
    ...
    <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
        ...
        <div class="xl:col-span-12 col-span-12">
            ...
            <input type="text" name="task_name" class="form-control form-control-lg" id="task_name" required
        ...
        <div class="xl:col-span-6 col-span-12" style="display: none">
            ...
            <input type="text" name="task_id" class="form-control font-800" readonly id="task_id"
                value="{{ uniqid() }}" required placeholder="Enter Task ID">
        </div>
        ...
        <div class="xl:col-span-6 col-span-12">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="date" name="assigned_date" value="{{ date('Y-m-d') }}" class="form-control"
        ...
        <input class="form-control xl:col-span-12 hidden" name="status_update" id="status_update" class=""
            style="width: 200% !important" required>
        <span id="description-error" class="text-red-500 hidden">Task description is
            required.</span>
        <div class="xl:col-span-12 col-span-12">
            <label class="form-label">Task Description :</label>
            <div contenteditable="false" id="project-descriptioin-editor" oninput="updateDescription()"
