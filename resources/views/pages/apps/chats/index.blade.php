    ...
    <div class="main-chart-wrapper lg:gap-2 gap-0 mb-2 lg:flex">
        <div class="chat-info border border-defaultborder dark:border-defaultborder/10">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane {{ !isset($_GET['contact']) ?? 'show active'}} border-0 chat-users-tab" id="users-tab1" role="tabpanel"
                    ...
                    <ul class="list-none mb-0 mt-2 chat-users-tab" id="chat-msg-scroll">
                        ...
                        <div id="discussion-message">
                            @include('pages.apps.chats.modules.messages')
                        </div>


                    </ul>
                </div>
                <div class="tab-pane {{ !isset($_GET['contact']) ?? 'show active'}} border-0 chat-groups-tab hidden" id="groups-tab-pane" role="tabpanel"
                ...
                <div class="tab-pane border-0 chat-contacts-tab hidden" id="contacts-tab-pane" role="tabpanel"
                    ...
                    <ul class="list-none mb-0 chat-contacts-tab">
                        <li>
                            <span class="text-defaulttextcolor font-semibold">Chats</span>
                        </li>
                        @foreach (App\Models\User::where('role', '<>', 'Sub-Client')->get() as $user)
                            <li>
                                <a href="/chat/{{ $user->id }}?contact">
