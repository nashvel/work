        ...
        <div class="col-span-12 xl:col-span-12">
            <div class="box">
                <div class="box-body p-5">
                    <form method="POST" action="{{ route('pt.expense.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <select name="project_id" id="project_id" class="ti-form-input rounded-sm ps-11" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="text" name="category" id="category" placeholder="e.g. Materials, Labor"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="3" class="ti-form-input rounded-sm w-full" placeholder="Optional notes..."></textarea>
                        </div>

                        <div class="flex justify-end gap-2">
                            <button type="reset" class="bg-gray-200 text-dark px-4 py-2 rounded hover:bg-gray-300">Cancel</button>
