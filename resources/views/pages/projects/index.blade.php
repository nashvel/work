<x-app-layout>
    ...
    <x-slot name="buttons">
        <a href="/project/register"
            class="ti-btn ti-btn-light text-dark bg-white !border-0 btn-wave me-0 waves-effect waves-light"
            data-hs-overlay="#modal_default">
        ...
        <div class="xl:col-span-12 col-span-12">
            <div class="box custom-box">
                <div class="box-header">
                    <div class="box-body">
                        @include('pages.projects.table.list')
                    </div>
                </div>
            </div>
        </div>
