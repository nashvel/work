<x-app-layout>
    ...
    <x-slot name="active">Bidding</x-slot>
    <x-slot name="buttons">
                    ...
                    <div class="box overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <span class="badge nft-like-badge text-white"><i
                                    class="ri-heart-fill me-1 text-danger align-middle inline-block"></i>
                                @if (Auth::user()->role == 'Client')
                                    {{ number_format($prospec_bid, 0) }}
                                @else
                                    {{ number_format($bid, 0) }}
                                @endif
                            </span>
                            ...
                            <div class="flex mb-3 items-center flex-wrap gap-2">
                                <div class="flex-auto">
                                    <p class="mb-0 text-xs font-medium">
                                        Date Start :
                                        <b>{{ date_format(date_create($data->start_date), 'D, F d, Y h:i A') }}</b>
                                        <br>
                                        Date End :
                                        <b>{{ date_format(date_create($data->end_date), 'D, F d, Y h:i A') }}</b>
                                    </p>
                                    <hr class="mt-2">
                                </div>
                            </div>
                            ...
                            <div class="grid">
                                <form id="bid-form" data-project-id="{{ $data->id }}">
                                    ...
                                    <center>
                                        ...
                                        <button type="button"
                                            class="ti-btn ti-btn-sm bg-danger w-500 text-white mb-md-0 mb-0"
