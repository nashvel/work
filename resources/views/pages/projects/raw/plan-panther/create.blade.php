                    ...
                    <div class="box-body">
                        ...
                        <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
                            ...
                            <script>
                                ...
                                //     console.log("🚀 Select2 initialized for #assigned-team-members");
                                ...
                                //                 console.log("🔍 Sending search query:", params.term);
                                //                 return {
                                //                     search: params.term
                                //                 }; // Send search query
                                //             },
                                ...
                                //     // Debug when an option is selected
                                //     $('#assigned-team-members').on('select2:select', function(e) {
                                //         console.log("🎯 Selected bidder:", e.params.data);
                                //     });

                                //     // Debug when the search field is cleared
